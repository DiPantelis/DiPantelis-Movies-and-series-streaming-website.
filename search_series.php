<html>
	...
	<div align="Center" >
	<fieldset >
	<form action="search_seira.php" method="POST">		
				 
	<font color="white"> <h1> Επιλέξτε τον τρόπο αναζήτησης της σειράς και κατόπιν συμπληρώστε το πεδίο αναζήτησης. </h1> </font>
	<font color="white"> <h1>Αναζήτηση σειράς βάσει: </h1> </font>
	<select name="choice2">											
